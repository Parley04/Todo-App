...
export interface IItemTagsClient {
...
export class ItemTagsClient implements IItemTagsClient {
    ...
    create(command: CreateItemTagCommand): Observable<number> {
        let url_ = this.baseUrl + "/api/ItemTags";
        url_ = url_.replace(/[?&]$/, "");
    ...
    update(id: number, command: UpdateItemTagCommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/ItemTags/{id}";
...
export interface ITagsClient {
    getUnchosenTags(userId: string | null, todoItemId: number): Observable<Tag[]>;
    getChosenTags(userId: string | null, todoItemId: number): Observable<Tag[]>;
...
export class TagsClient implements ITagsClient {
    ...
    getUnchosenTags(userId: string | null, todoItemId: number): Observable<Tag[]> {
        let url_ = this.baseUrl + "/api/Tags/{userId}/{todoItemId}";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetUnchosenTags(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetUnchosenTags(response_ as any);
                } catch (e) {
    ...
    protected processGetUnchosenTags(response: HttpResponseBase): Observable<Tag[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    getChosenTags(userId: string | null, todoItemId: number): Observable<Tag[]> {
        let url_ = this.baseUrl + "/api/Tags/ChosenTags/{userId}/{todoItemId}";
        if (userId === undefined || userId === null)
            throw new Error("The parameter 'userId' must be defined.");
        url_ = url_.replace("{userId}", encodeURIComponent("" + userId));
        if (todoItemId === undefined || todoItemId === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetChosenTags(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetChosenTags(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<Tag[]>;
                }
            } else
    ...
    protected processGetChosenTags(response: HttpResponseBase): Observable<Tag[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export interface ITodoItemsClient {
    getTodoItemsWithPagination(userId: string | null | undefined, listId: number | undefined, pageNumber: number | undefined, pageSize: number | undefined): Observable<PaginatedListOfTodoItemBriefDto>;
...
export interface ITodoListsClient {
    getList(userId: string | null): Observable<TodosVm>;
...
export class TodoListsClient implements ITodoListsClient {
    ...
    getList(userId: string | null): Observable<TodosVm> {
        let url_ = this.baseUrl + "/api/TodoLists/{userId}";
        if (userId === undefined || userId === null)
            throw new Error("The parameter 'userId' must be defined.");
        url_ = url_.replace("{userId}", encodeURIComponent("" + userId));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetList(response: HttpResponseBase): Observable<TodosVm> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class CreateItemTagCommand implements ICreateItemTagCommand {
    todoItemId?: number;
    tagId?: number;

    constructor(data?: ICreateItemTagCommand) {
        if (data) {
    ...
    static fromJS(data: any): CreateItemTagCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateItemTagCommand();
        result.init(data);
        return result;
    }
...
export interface ICreateItemTagCommand {
    todoItemId?: number;
    tagId?: number;
}

export class UpdateItemTagCommand implements IUpdateItemTagCommand {
    id?: number;
    todoItemId?: number;
    tagId?: number;

    constructor(data?: IUpdateItemTagCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateItemTagCommand {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateItemTagCommand();
        result.init(data);
        return result;
    }
...
export interface IUpdateItemTagCommand {
    id?: number;
    todoItemId?: number;
    tagId?: number;
}
...
export class Tag extends BaseAuditableEntity implements ITag {
    ...
    override init(_data?: any) {
        ...
        if (_data) {
            ...
            this.countUses = _data["countUses"];
...
export class ItemTag extends BaseAuditableEntity implements IItemTag {
    todoItemId?: number;
    todoItem?: TodoItem;
    tagId?: number;
    tag?: Tag;
    ...
    static override fromJS(data: any): ItemTag {
        data = typeof data === 'object' ? data : {};
...
export interface IItemTag extends IBaseAuditableEntity {
    todoItemId?: number;
    todoItem?: TodoItem;
    tagId?: number;
    tag?: Tag;
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["itemTags"])) {
                ...
                for (let item of _data["itemTags"])
                    this.itemTags!.push(ItemTag.fromJS(item));
            }
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["colours"])) {
                ...
                for (let item of _data["colours"])
                    this.colours!.push(Colour.fromJS(item));
            }
        }
    }
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["itemTags"])) {
                this.itemTags = [] as any;
                for (let item of _data["itemTags"])
                    this.itemTags!.push(ItemTagDto.fromJS(item));
            }
        }
    }
...
export class ItemTagDto implements IItemTagDto {
    id?: number;
    todoItemId?: number;
    tagId?: number;
    tags?: TagDto[] | undefined;

    constructor(data?: IItemTagDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ItemTagDto {
        data = typeof data === 'object' ? data : {};
        let result = new ItemTagDto();
        result.init(data);
        return result;
    }
